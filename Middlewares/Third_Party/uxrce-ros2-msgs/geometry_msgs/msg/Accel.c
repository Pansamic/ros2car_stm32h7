...
bool geometry_msgs_msg_Accel_serialize_topic(ucdrBuffer* writer, const geometry_msgs_msg_Accel* topic)
{
    bool success = true;
...
bool geometry_msgs_msg_Accel_deserialize_topic(ucdrBuffer* reader, geometry_msgs_msg_Accel* topic)
{
    bool success = true;
