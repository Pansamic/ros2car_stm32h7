...
/*!
 * @file ModelCoefficients.c
 * This source file contains the definition of the described types in the IDL file.
 *
 * This file was generated by the tool gen.
 */

#include "pcl_msgs/msg/ModelCoefficients.h"

#include <ucdr/microcdr.h>
#include <string.h>

bool pcl_msgs_msg_ModelCoefficients_serialize_topic(ucdrBuffer* writer, const pcl_msgs_msg_ModelCoefficients* topic)
{
    bool success = true;
...
bool pcl_msgs_msg_ModelCoefficients_deserialize_topic(ucdrBuffer* reader, pcl_msgs_msg_ModelCoefficients* topic)
{
    bool success = true;
