...
bool std_msgs_msg_UInt8MultiArray_serialize_topic(ucdrBuffer* writer, const std_msgs_msg_UInt8MultiArray* topic)
{
    bool success = true;
...
bool std_msgs_msg_UInt8MultiArray_deserialize_topic(ucdrBuffer* reader, std_msgs_msg_UInt8MultiArray* topic)
{
    bool success = true;
