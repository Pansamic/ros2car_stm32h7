...
/*!
 * @file Int8MultiArray.c
 * This source file contains the definition of the described types in the IDL file.
 *
 * This file was generated by the tool gen.
 */

#include "std_msgs/msg/Int8MultiArray.h"

#include <ucdr/microcdr.h>
#include <string.h>

bool std_msgs_msg_Int8MultiArray_serialize_topic(ucdrBuffer* writer, const std_msgs_msg_Int8MultiArray* topic)
{
    bool success = true;
...
bool std_msgs_msg_Int8MultiArray_deserialize_topic(ucdrBuffer* reader, std_msgs_msg_Int8MultiArray* topic)
{
    bool success = true;
