...
bool sensor_msgs_msg_CompressedImage_serialize_topic(ucdrBuffer* writer, const sensor_msgs_msg_CompressedImage* topic)
{
    bool success = true;

        success &= std_msgs_msg_Header_serialize_topic(writer, &topic->header);
        success &= ucdr_serialize_string(writer, topic->format);
...
bool sensor_msgs_msg_CompressedImage_deserialize_topic(ucdrBuffer* reader, sensor_msgs_msg_CompressedImage* topic)
{
    bool success = true;

        success &= std_msgs_msg_Header_deserialize_topic(reader, &topic->header);
        success &= ucdr_deserialize_string(reader, topic->format, 255);
...
uint32_t sensor_msgs_msg_CompressedImage_size_of_topic(const sensor_msgs_msg_CompressedImage* topic, uint32_t size)
{
