...
bool sensor_msgs_msg_Image_serialize_topic(ucdrBuffer* writer, const sensor_msgs_msg_Image* topic)
{
    bool success = true;
        ...
        success &= ucdr_serialize_string(writer, topic->encoding);

        success &= ucdr_serialize_uint8_t(writer, topic->is_bigendian);

        success &= ucdr_serialize_uint32_t(writer, topic->step);
...
bool sensor_msgs_msg_Image_deserialize_topic(ucdrBuffer* reader, sensor_msgs_msg_Image* topic)
{
    bool success = true;
        ...
        success &= ucdr_deserialize_string(reader, topic->encoding, 255);

        success &= ucdr_deserialize_uint8_t(reader, &topic->is_bigendian);

        success &= ucdr_deserialize_uint32_t(reader, &topic->step);
