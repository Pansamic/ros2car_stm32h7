...
void ptpd_protocol_to_state(PtpClock *ptp_clock, uint8_t state)
{
    ...
    switch (state)
    {
        case PTP_INITIALIZING:
            ...
            LOG_INFO("PTPD: entering INITIALIZING state\n");
            break;

        case PTP_FAULTY:
            ptp_clock->portDS.portState = PTP_FAULTY;
            LOG_INFO("PTPD: entering FAULTY state\n");
            break;

        case PTP_DISABLED:
            ptp_clock->portDS.portState = PTP_DISABLED;
            LOG_INFO("PTPD: entering DISABLED state\n");
            break;
        ...
        case PTP_LISTENING:
            ...
            LOG_INFO("PTPD: entering LISTENING state\n");
            break;
        ...
        case PTP_MASTER:
            ...
            LOG_INFO("PTPD: entering MASTER state.\n");
            break;
        ...
        case PTP_PASSIVE:
            ...
            LOG_INFO("PTPD: entering PASSIVE state.\n");
            break;
        ...
        case PTP_UNCALIBRATED:
            ...
            LOG_INFO("PTPD: entering UNCALIBRATED state\n");
            break;

        case PTP_SLAVE:
            ptp_clock->portDS.portState = PTP_SLAVE;
            LOG_INFO("PTPD: entering SLAVE state\n");
            break;
    ...
    switch (ptp_clock->portDS.portState)
    {
        ...
        case PTP_SLAVE:
            ...
            if (is_from_current_parent)
            {
                ...
                ptpd_timer_start(ANNOUNCE_RECEIPT_TIMER, ptp_clock->portDS.announceReceiptTimeout * pow2ms(ptp_clock->portDS.logAnnounceInterval));
            }
            else
            {
...
{
    (void)ptp_clock; (void)is_from_self;
    // Do nothing.
}
