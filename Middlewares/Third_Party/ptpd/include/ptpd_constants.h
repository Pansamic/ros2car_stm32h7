...
#define DEFAULT_CLOCK_ACCURACY          0x20
...
#define DEFAULT_CALIBRATED_OFFSET_NS    100     // Offset from master < 100ns -> calibrated
#define DEFAULT_UNCALIBRATED_OFFSET_NS  1000000   // Offset from master > 1000us -> uncalibrated
#define MAX_ADJ_OFFSET_NS               500000000  // Max offset to try to adjust it < 500ms
